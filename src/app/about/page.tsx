    ...
    <div className="container min-h-screen m-auto">
      ...
      <section className="flex-1 h-screen p-6 flex flex-col bg-white">
        ...
        <div className="flex flex-col p-4">
          ...
          <a href="https://github.com/davihenriquelima/projeto" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Repositório no GitHub</a>
        </div>
      </section>
      <Footer/>
    </div>
